...
function ComboboxItem({
  ...
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        "data-highlighted:bg-accent data-highlighted:text-accent-foreground not-data-[variant=destructive]:data-highlighted:**:text-accent-foreground gap-3 rounded-lg py-2.5 pr-9 pl-3.5 text-sm [&_svg:not([class*='size-'])]:size-4 relative flex w-full cursor-default items-center select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
        className
      )}
      {...props}
    >
...
function ComboboxChips({
  ...
  return (
    <ComboboxPrimitive.Chips
      ...
      className={cn("bg-input/30 border-input aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 focus-within:outline focus-within:outline-[length:var(--focus-ring-width)] focus-within:outline-[var(--focus-ring-color)] focus-within:outline-offset-[var(--focus-ring-offset)] aria-invalid:focus-within:outline-[var(--destructive)] flex min-h-9 flex-wrap items-center gap-1.5 rounded-lg border bg-clip-padding px-2.5 py-1.5 text-sm transition-colors has-data-[slot=combobox-chip]:px-1.5", className)}
      {...props}
    />
  )
}
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        "bg-muted-foreground/10 text-foreground flex h-6 w-fit items-center justify-center gap-1 rounded-4xl px-2 text-xs font-medium whitespace-nowrap has-data-[slot=combobox-chip-remove]:pr-0 has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50",
        className
      )}
      {...props}
    >
...
function ComboboxChipsInput({
  ...
  return (
    <ComboboxPrimitive.Input
      ...
      className={cn(
        "min-w-16 flex-1 !outline-none focus:!outline-none focus-visible:!outline-none",
        className
      )}
      {...props}
    />
